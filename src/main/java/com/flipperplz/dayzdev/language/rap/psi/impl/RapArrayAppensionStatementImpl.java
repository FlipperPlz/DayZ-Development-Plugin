...
public class RapArrayAppensionStatementImpl extends ASTWrapperPsiElement implements RapArrayAppensionStatement {

  public RapArrayAppensionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RapVisitor visitor) {
    visitor.visitArrayAppensionStatement(this);
  }
