...
public class EsFunctionCallParameterImpl extends ASTWrapperPsiElement implements EsFunctionCallParameter {

  public EsFunctionCallParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public EsOptionalFunctionCallParam getOptionalFunctionCallParam() {
    return findChildByClass(EsOptionalFunctionCallParam.class);
  }
