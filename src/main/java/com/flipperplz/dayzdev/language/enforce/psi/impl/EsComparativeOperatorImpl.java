...
public class EsComparativeOperatorImpl extends ASTWrapperPsiElement implements EsComparativeOperator {

  public EsComparativeOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EsVisitor visitor) {
    visitor.visitComparativeOperator(this);
  }
