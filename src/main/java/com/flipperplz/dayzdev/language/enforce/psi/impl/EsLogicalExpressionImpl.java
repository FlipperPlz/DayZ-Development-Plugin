...
public class EsLogicalExpressionImpl extends EsExpressionImpl implements EsLogicalExpression {

  public EsLogicalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public EsLogicalOperator getLogicalOperator() {
    return findNotNullChildByClass(EsLogicalOperator.class);
  }
