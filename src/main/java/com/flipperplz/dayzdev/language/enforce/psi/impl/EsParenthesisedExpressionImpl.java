...
public class EsParenthesisedExpressionImpl extends EsExpressionImpl implements EsParenthesisedExpression {

  public EsParenthesisedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
