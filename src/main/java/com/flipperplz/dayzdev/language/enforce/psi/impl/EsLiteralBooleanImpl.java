...
public class EsLiteralBooleanImpl extends EsPrimaryExpressionImpl implements EsLiteralBoolean {

  public EsLiteralBooleanImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getBooleanLiteral() {
    return findNotNullChildByType(BOOLEAN_LITERAL);
  }
