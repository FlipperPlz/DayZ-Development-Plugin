...
public class EsAssignmentOperatorImpl extends ASTWrapperPsiElement implements EsAssignmentOperator {

  public EsAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
