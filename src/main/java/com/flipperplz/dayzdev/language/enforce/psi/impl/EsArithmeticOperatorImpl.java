...
public class EsArithmeticOperatorImpl extends ASTWrapperPsiElement implements EsArithmeticOperator {

  public EsArithmeticOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
