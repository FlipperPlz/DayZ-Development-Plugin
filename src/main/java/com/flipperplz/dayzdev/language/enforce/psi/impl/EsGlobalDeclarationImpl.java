...
public class EsGlobalDeclarationImpl extends ASTWrapperPsiElement implements EsGlobalDeclaration {

  public EsGlobalDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public EsFunctionDeclaration getFunctionDeclaration() {
    return findChildByClass(EsFunctionDeclaration.class);
  }
