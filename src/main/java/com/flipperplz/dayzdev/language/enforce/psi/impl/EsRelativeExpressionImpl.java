...
public class EsRelativeExpressionImpl extends EsExpressionImpl implements EsRelativeExpression {

  public EsRelativeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public EsComparativeOperator getComparativeOperator() {
    return findNotNullChildByClass(EsComparativeOperator.class);
  }
