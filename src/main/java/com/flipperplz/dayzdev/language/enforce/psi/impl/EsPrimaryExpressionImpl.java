...
public class EsPrimaryExpressionImpl extends EsExpressionImpl implements EsPrimaryExpression {

  public EsPrimaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public EsClassReference getClassReference() {
    return findChildByClass(EsClassReference.class);
  }

  @Override
  @Nullable
  public EsFunctionCall getFunctionCall() {
    return findChildByClass(EsFunctionCall.class);
  }
