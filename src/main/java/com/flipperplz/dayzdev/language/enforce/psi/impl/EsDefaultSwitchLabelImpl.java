...
public class EsDefaultSwitchLabelImpl extends ASTWrapperPsiElement implements EsDefaultSwitchLabel {

  public EsDefaultSwitchLabelImpl(@NotNull ASTNode node) {
    super(node);
  }
