...
public class EsArrayIndexExpressionImpl extends EsExpressionImpl implements EsArrayIndexExpression {

  public EsArrayIndexExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public EsArrayIndex getArrayIndex() {
    return findNotNullChildByClass(EsArrayIndex.class);
  }
