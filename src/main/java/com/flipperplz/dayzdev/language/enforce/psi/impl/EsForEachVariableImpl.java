...
public class EsForEachVariableImpl extends ASTWrapperPsiElement implements EsForEachVariable {

  public EsForEachVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EsVisitor visitor) {
    visitor.visitForEachVariable(this);
  }
