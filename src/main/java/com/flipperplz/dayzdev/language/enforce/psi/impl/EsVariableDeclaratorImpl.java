...
public class EsVariableDeclaratorImpl extends ASTWrapperPsiElement implements EsVariableDeclarator {

  public EsVariableDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public EsArrayIndex getArrayIndex() {
    return findChildByClass(EsArrayIndex.class);
  }
