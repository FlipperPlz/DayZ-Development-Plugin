...
public class EsSwitchLabelImpl extends ASTWrapperPsiElement implements EsSwitchLabel {

  public EsSwitchLabelImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EsStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EsStatement.class);
  }
