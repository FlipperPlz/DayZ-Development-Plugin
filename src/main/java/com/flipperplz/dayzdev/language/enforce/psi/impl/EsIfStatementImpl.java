...
public class EsIfStatementImpl extends ASTWrapperPsiElement implements EsIfStatement {

  public EsIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public EsElseStatement getElseStatement() {
    return findChildByClass(EsElseStatement.class);
  }
