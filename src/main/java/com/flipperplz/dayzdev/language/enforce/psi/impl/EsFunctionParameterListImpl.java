...
public class EsFunctionParameterListImpl extends ASTWrapperPsiElement implements EsFunctionParameterList {

  public EsFunctionParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EsFunctionParameter> getFunctionParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EsFunctionParameter.class);
  }
