...
public class EsClassReferenceImpl extends ASTWrapperPsiElement implements EsClassReference {

  public EsClassReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public EsTypeList getTypeList() {
    return findChildByClass(EsTypeList.class);
  }
