...
public class EsUnaryPrefixOperatorImpl extends ASTWrapperPsiElement implements EsUnaryPrefixOperator {

  public EsUnaryPrefixOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
