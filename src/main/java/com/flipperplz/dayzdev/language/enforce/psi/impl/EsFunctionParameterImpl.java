...
public class EsFunctionParameterImpl extends ASTWrapperPsiElement implements EsFunctionParameter {

  public EsFunctionParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public EsVariableDeclarator getVariableDeclarator() {
    return findNotNullChildByClass(EsVariableDeclarator.class);
  }
