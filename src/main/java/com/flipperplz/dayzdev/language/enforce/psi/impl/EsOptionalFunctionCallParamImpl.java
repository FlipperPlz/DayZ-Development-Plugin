...
public class EsOptionalFunctionCallParamImpl extends ASTWrapperPsiElement implements EsOptionalFunctionCallParam {

  public EsOptionalFunctionCallParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EsVisitor visitor) {
    visitor.visitOptionalFunctionCallParam(this);
  }
