...
public class EsLiteralFloatImpl extends EsPrimaryExpressionImpl implements EsLiteralFloat {

  public EsLiteralFloatImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getFloatLiteral() {
    return findNotNullChildByType(FLOAT_LITERAL);
  }
