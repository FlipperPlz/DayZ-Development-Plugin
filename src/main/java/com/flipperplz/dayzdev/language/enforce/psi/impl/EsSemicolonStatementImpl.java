...
public class EsSemicolonStatementImpl extends ASTWrapperPsiElement implements EsSemicolonStatement {

  public EsSemicolonStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
