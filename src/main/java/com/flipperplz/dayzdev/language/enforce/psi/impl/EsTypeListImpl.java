...
public class EsTypeListImpl extends ASTWrapperPsiElement implements EsTypeList {

  public EsTypeListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EsGenericType> getGenericTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EsGenericType.class);
  }
